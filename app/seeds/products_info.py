...
def seed_products():
    ...
    beige_slim_fit_pants = Product(
        product_type_id=10, color="Beige",
    ...
    dark_green_slim_fit_suit = Product(
        product_type_id=11, color="DarkGreen",
    ...
    burgundy_dinner_jacket = Product(
        product_type_id=12, color="Burgundy",
    ...
    brown_leather_belt = Product(
        product_type_id=18, color="Brown",
    ...
    black_leather_shoes = Product(
        product_type_id=19, color="Black",
    ...
    beige_linen_blazer = Product(
        product_type_id=22, color="Beige",
    ...
    white_tuxedo_shirt = Product(
        product_type_id=23, color="White",
    ...
    black_dress_oxfords = Product(
        product_type_id=24, color="Black",
    ...
    black_suit_jacket = Product(
        product_type_id=27, color="Black",
    ...
    brown_oxford_shoes = Product(
        product_type_id=30, color="Brown",
    ...
    white_dress_shoes = Product(
        product_type_id=32, color="White",
    ...
    maroon_silk_tie = Product(
        product_type_id=33, color="Maroon",
    ...
    black_suit_vest = Product(
        product_type_id=36, color="Black",
    ...
    white_dress_belt = Product(
        product_type_id=42, color="White",
